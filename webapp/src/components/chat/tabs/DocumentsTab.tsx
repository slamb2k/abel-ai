        ...
        >
            <div className={classes.functional}>
                ...
                <input
                    ...
                    multiple={true}
                    onChange={() => {
                        // Documents uploaded here will be stored in global document store.
                        void fileHandler.handleImport(selectedId, documentFileRef, true);
                    }}
                />
